...
export class CloudLayer2Material {
    constructor() {
    ...
    material.onBeforeCompile = (shader) =>
    {
        ...
        shader.vertexShader = shader.vertexShader.replace(
            ...
            `
                ...
                float displacementIntensity = smoothstep(0.3, 0.7,texture2D( displacementMap, vUv ).x);
        ...
        shader.fragmentShader = shader.fragmentShader.replace(
            ...
            `
                ...
                float intensity = smoothstep(0.25, 0.6, texture2D( alphaMap, vUv).g);
