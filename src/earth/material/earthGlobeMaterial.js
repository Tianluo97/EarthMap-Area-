...
export class EarthMaterial  {
    ...
    const colorTexture = new THREE.TextureLoader().load('./earth/textures/earth3.jpg'); 
    ...
    shader.fragmentShader = shader.fragmentShader.replace(
        ...
        `
            #include <map_fragment>
            diffuseColor  = vec4(0.129,0.282,0.498,1.0) + sampledDiffuseColor * mapIntensity; 
        `
    )
